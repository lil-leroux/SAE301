        ...
        <?php foreach ($produits as $produit) { ?>
            ...
            <!-- <img src="<?php echo base_url('img/couleur.png'); ?>" alt="" srcset=""> -->
                ...
                <div class="card">
                    ...
                    <div class="bloc">      <p> <?php echo $produit->type; ?> </p>
                    <p> <?php echo $produit->description; ?> </p></div>
                ...
                <div class="fonction-card">
                    ...
                    <!-- bouton d'achat -->
                    <a href="<?php echo base_url('index.php/product/Productdescription?add=' . $produit->id); ?>">
